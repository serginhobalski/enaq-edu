...
class NotaController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            foreach ($notas as $nota) {
                $data[] = [
                    ...
                    'aluno' => $nota->aluno . ' ' . $nota->sobrenome,
                    'nome' => $nota->nome,
                    'nota' => $nota->nota,
    ...
    public function cad_notas()
    {
        ...
        return view('notas.cad_notas', $data);
    }
    ...
    public function store_notas(Request $request)
    {
        // dd($request);
        $request->validate([
            'disciplina_id' => ['required', 'string'],
        ...
        foreach ($request->user_id as  $aluno) {
            $nota = new Nota();
