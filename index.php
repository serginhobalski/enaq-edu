// <?php
// header("refresh: 1; https://itq.seecpa.app/public/");
//     echo '<title></title><div style="padding: 15px;" align="center" >
//     <font size="5" color="#182e7a">Instituto Teológico Quadrangular</font><br /><br /></font>
//     <img src="https://itq.seecpa.app/public/logo.png">
//     </div>';
// ?>
<!DOCTYPE html>
<html lang="pt">
    <head>
        <title>SEEC -PA</title>
        <link rel="icon" type="image/x-icon" href="https://seecpa.app/postulantes/public/favicon.png">
        <meta charset="utf-8">
    ...
    <body>
        <nav class="navigation">
            <a href="#" rel="nofollow" style="color: #fff; decoration-text: none;">
                <img src="https://seecpa.app/postulantes/public/logo2.png" width="150px;">
            </a>
        </nav>
        <div class="content">
            <svg 
            ...
            <p>Estamos realizando uma migração em nossos servidores...</p>
