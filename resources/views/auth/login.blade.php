...
{{-- <div class="account-container">
    <div class="heading-bx left">
        ...
        <p>Não possui acesso? <a href="https://api.whatsapp.com/send/?phone=5591991882198&text=Paz!+Estou+precisando+de+ajuda+para+entrar+na+plataforma+do+ITQ.&type=phone_number&app_absent=0">fale conosco</a></p>
    </div>
        ...
        <div class="row placeani">
            ...
            <div class="col-lg-12">
                <div class="form-group form-forget">
                    ...
                    <a href="https://api.whatsapp.com/send/?phone=5591991882198&text=Paz!+Estou+precisando+de+ajuda+para+entrar+na+plataforma+do+ITQ.&type=phone_number&app_absent=0" class="ml-auto">Esqueceu a senha?</a>
                </div>
            </div>
