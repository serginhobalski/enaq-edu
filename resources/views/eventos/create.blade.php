                    ...
                    <div class="widget-inner">
                        <form method="POST" action="{{ route('eventos.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="start" class="form-control"  type="datetime" name="start" id="" value="{{ old('Início') }}"  autocomplete="start" required placeholder="2023-10-17 00:00:00">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="end" class="form-control"  type="datetime" name="end" id="" value="{{ old('Fim') }}"  autocomplete="end" required placeholder="2023-10-17 00:00:00">
                                </div>
                            </div>
