            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="custom-module p40l">
                        <h2 class="text-white">O <mark>Curso de Postulantes:</mark><br>
                            Curso preparatório para postulantes ao ingresso ou <br>
                            progressão ministerial na Igreja do Evangelho Quadrangular.</h2>

                        <p><strong>Objetivo:</strong> Este curso tem como objetivo capacitar o postulante para a realização do Exame Nacional Quadrangular (ENAQ), uma prova obrigatória para quem deseja fazer parte do ministério Quadrangular ou realizar a progressão ministerial.</p>
                    ...
                    @if (!$aluno_cursos || $aluno_cursos == 0)
                        <p class="text-white">Nenhum curso encontrado.</p>
                    @else
                            ...
                            <div class="caro-item">
                                <div class="course-box">
                                    <div class="image-wrap entry">
                                        <img src="{{asset('edu/images/' . $curso->imagem)}}" alt="" class="img-responsive">
                                        <div class="magnifier">
