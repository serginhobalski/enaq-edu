...
<body>
    ...
    <!-- LOADER -->
    <div id="preloader">
        <img class="preloader" src="{{asset('edu')}}/images/enaqloader.gif" alt="">
    </div>
    <!-- END LOADER -->
                ...
                <nav class="navbar navbar-default yamm">
                    <div class="navbar-header">
                        ...
                        <div class="logo-normal">
                            <a class="navbar-brand" href="{{url('home')}}"><img src="{{asset('enaq.png')}}" width="100px" alt=""></a>
                        </div>
                    </div>
                        ...
                        <div class="widget clearfix">
                            ...
                            <div class="tags-widget">
                                <ul class="list-inline">
                                    <li><a href="{{url('meus_avisos')}}">Avisos</a></li>
            ...
            <div class="container">
                <div class="clearfix">
                    <div class="pull-left">
                        <div class="cop-logo">
                            <a href="{{url('home')}}">
                                <img src="<?php echo asset('enaq.png') ?>" width="80px" alt="">
                            </a>
                        </div>
                    </div>
