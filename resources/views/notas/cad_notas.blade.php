        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-white text-center bg-primary">
                    <h3>{{ __('CADASTRAR NOTAS EM LOTE') }}</h3>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ url('adm/store_notas') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="user_id[]" id="user_id" multiple>
                                    ...
                                    <option value="{{$aluno->id}}">{{$aluno->name . ' ' . $aluno->surname}}</option>
                                    @endforeach
                                </select>
                            </div>
